...
//----- Here you can declare AutoCAD commands from Dictionaries class
ACED_ARXCOMMAND_ENTRY_AUTO(DictionariesClass, ADSK, _TEST_LIST_NOD, TEST_LIST_NOD, ACRX_CMD_MODAL, NULL)
ACED_ARXCOMMAND_ENTRY_AUTO(DictionariesClass, ADSK, _TEST_ADD_NOD, TEST_ADD_NOD, ACRX_CMD_MODAL, NULL)
ACED_ARXCOMMAND_ENTRY_AUTO(DictionariesClass, ADSK, _TEST_ADD_NOD_DATA, TEST_ADD_NOD_DATA, ACRX_CMD_MODAL, NULL)
